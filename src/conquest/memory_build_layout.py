...
READ_LAYOUTS = {
    CLIENT_SHA256_1074: ReadBuildLayout(CLIENT_SHA256_1074,'classic-1074-player-candidate.yaml',
        'classic-1074-inventory-candidate.yaml',0x5CF220,_OLD_SLOTS,0x6966F0,0x6986C0,
        0x69C730,0x1008,0x1030,0x1044,0x16,0x5CBA68),
    CLIENT_SHA256_1078: ReadBuildLayout(CLIENT_SHA256_1078,'classic-1078-player-candidate.yaml',
        'classic-1078-inventory-candidate.yaml',0x5EA9F8,_NEW_SLOTS,0x6B5EF0,0x6B8E48,
        0x6BCEF0,0x1030,0x1058,0x106C,0x16,0x5E7250),
}
