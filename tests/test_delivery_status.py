...
def test_only_resolved_terminal_status_releases_route():
    receipt={'request_id':'x','outcome':'transferred','next_action':'finalize_receiver_receipt'}
...
def test_proven_untouched_rejection_is_deferred_not_failure():
    receipt={'request_id':'x','outcome':'retryable_before_input','next_action':'release_route'}
