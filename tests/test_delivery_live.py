...
@pytest.mark.parametrize(
    "phase,stage", [("request_verified", "accept"), ("offer_verified", "confirm")]
)
def test_stage_completes_durable_override_before_phase_gating(
...
def test_stage_fails_closed_without_valid_dictionary_journal(
    tmp_path, monkeypatch, contents, stage
):
    ui, path = setup_stage(monkeypatch, tmp_path)
...
def test_invalid_override_intent_cannot_reauthorize_original_stage(
