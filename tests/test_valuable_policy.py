...
import pytest
from conquest.valuables import DRAGONBALL_NAMES,DRAGONBALL_TYPES,STORAGE_ONLY_TYPES,storage_only,require_marketable
...
def test_checked_in_catalog_matches_policy():
    ...
    assert {r['type_id'] for r in data['definitions'] if r['storage_only']}==STORAGE_ONLY_TYPES
